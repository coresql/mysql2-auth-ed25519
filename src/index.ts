// Forked from https://github.com/mariadb-corporation/mariadb-connector-nodejs/blob/ca34b2da22a7aa3c6525ddd5014c930605b64148/lib/cmd/handshake/auth/ed25519-password-auth.js
...
// @ts-expect-error pluginOptions is not used, but defining it in case we need
// it later, similar to other plugins
export default (pluginOptions: {} = {}) =>
  ({ connection: { config: { password }} }: { connection: Connection }) =>
  (pluginData: Buffer): Buffer => {
    ...
    for (i = 0; i < 32; i++) signedMsg[64 + i] = pluginData[i];
